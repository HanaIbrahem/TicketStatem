                 ...
                 <div class="dropdown">
                     ...
                     <ul class="dropdown-menu">
                         ...
                         @if ($ticket->state == 'opened')
                             ...
                             <li>
                                 <a class="dropdown-item" href="{{ route('dashbord.ticket.state', $ticket->id) }}">
                         ...
                         <li>
                             <a class="dropdown-item" href="{{ route('dashbord.ticket.destroy', $ticket->id) }}"
                                 id="delete">
                     ...
                     <ul class="dropdown-menu">
                         ...
                         <li>
                             @if ($ticket->state != 'approved')
                                 <a class="dropdown-item" href="{{ route('dashbord.pending.approve', $ticket->id) }}">
                         ...
                         <li>
                             <a class="dropdown-item" href="{{ route('dashbord.ticket.edit', $ticket->id) }}">Edit</a>
                         </li>
