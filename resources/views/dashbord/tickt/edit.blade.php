                        ...
                        <div class="row p-2 border border-3 rounded mt-2 ">
                            ...
                            <div class="col-md-12">
                                <div class="form-group p-2">
                                    ...
                                    <div class="form-check form-check-inline ">
                                        <input class="form-check-input info check-light-info" {{$ticket->reason=='Damaged intentionally'?'checked':''}}  type="radio" name="reasonOptions" id="Damaged intentionally" value="Damaged intentionally">
                                    ...
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input info check-light-info" {{$ticket->reason=='Damaged unintentionally'?'checked':''}} type="radio" name="reasonOptions" id="Damaged unintentionally" value="Damaged unintentionally">
                                        <label class="form-check-label" for="Damaged Device">Damaged unintentionally</label>
                                    </div>
                                    <div class="d-block d-sm-none p-0 m-0">           
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input info check-light-info" type="radio"  {{$ticket->reason=='IT Update'?'checked':''}} name="reasonOptions" id="IT Update" value="IT Update">
                            ...
                            <div class="col-md-12">
                                <div class="form-group  align-items-center">
                                    ...
                                    <input type="text" value="{{$ticket->responsibility}}" name="responsibility" class="form-control">
                                </div>
