...
<div class="row">
    <div class="col-12">
        ...
        <div class="card">
          <div class="card-body">
            <h4 class="card-title mb-3">Add Solution</h4>
            <form action="{{route('dashbord.solution.store')}}" method="POST">
             @csrf
             @method('POST')
              <div class="row">
                <div class="col-md-6">
                ...
                <table id="example" class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <x-status :status="$solution->is_active"></x-status>
                            </td>
                            <td>
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li>
                                            <a class="dropdown-item"
                                               href="{{ route("dashbord.solution.edit",$solution->id) }}">Edit</a>
                                        </li>
                                        <li>
                                            <a class="dropdown-item"
                                               href="{{ route("dashbord.solution.state",$solution->id)  }}">
